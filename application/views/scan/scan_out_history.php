            ...
            <div class="col-lg-12 col-md-12 col-xs-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 flex-row align-items-center justify-content-between">
                        ...
                        <h6 class="m-0 font-weight-bold align-middle text-primary text-center">Log Scan Out</h6>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    foreach ($history_out as $key) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?= $key->master_pallet ?></td>
                                            <td class="text-center"><?= $key->assy_code_pallet ?></td>
